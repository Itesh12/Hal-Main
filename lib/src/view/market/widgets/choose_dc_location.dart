...
@RoutePage()
class ChooseDCLocationPage extends ConsumerStatefulWidget {
  final bool fromAddNewAddress;

  const ChooseDCLocationPage({Key? key, this.fromAddNewAddress = true}) : super(key: key);

  @override
  ConsumerState<ChooseDCLocationPage> createState() => _ChooseDCLocationPageState();
}

class _ChooseDCLocationPageState extends ConsumerState<ChooseDCLocationPage> {
