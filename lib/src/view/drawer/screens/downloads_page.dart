...
final allCropReportProvider = FutureProvider
    .autoDispose<List<CropReport>>((ref) async {
  final val = await ref.read(farmRepoProvider).getDownloadReport();
  return val;
});
        ...
        children: [
          ...
          Expanded(
            child: Consumer(builder: (context, ref, child) {
              final res = ref.watch(allCropReportProvider);
              return res.when(
                data: (data) {
                  if (data.isNotEmpty) {
