...
class CarausalNewsTile extends StatelessWidget {
  const CarausalNewsTile(
      {Key? key,
       required this.agrimodel, required this.index})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: agrimodel.isNotEmpty ? InkWell(
        onTap: () {
          context.router.push(
        ...
        child: Container(
            ...
            decoration: BoxDecoration(
              ...
              DecorationImage(
                  fit: BoxFit.cover,
                  image: NetworkImage(agrimodel[index].image!.first.mediaUrl )
                //   Image.asset(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        if (agrimodel[index].createdAt != "null" || agrimodel[index].createdAt != "" || agrimodel[index].createdAt != null) Text(
